...
@interface LNCircularView : UIView
- (void)updateProgress:(CGFloat)progress;
- (CAShapeLayer *)shapeLayer;
@end

@implementation LNCircularView
...
@interface LNCircularProgressView ()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) LNCircularView *progressView;
@property (nonatomic, assign) int valueLabelProgressPercentDifference;
@property (nonatomic, strong) NSTimer *valueLabelUpdateTimer;
@end
@implementation LNCircularProgressView
...
- (void)sharedSetup{
    self.progressView = [[LNCircularView alloc] initWithFrame:self.bounds];
...
- (void)tintColorDidChange {
    ...
    self.progressView.shapeLayer.borderColor = [UIColor clearColor].CGColor;
}
